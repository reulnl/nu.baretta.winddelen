...
var devices = {};
//var windmillId = 1;
var baseurl1 = "http://backend.windcentrale.nl/windcentrale/productie_"
//_{id}.txt"
...
function checkProduction(device_data) {
    ...
    var url1 = baseurl1 + device_data.id + ".txt";
    ...
    http.get(url2).then(function(result) {
        if (result.response.statusCode == 200) {
            ...
            Homey.log("[" + device_data.name + "] Number of shares per mill: " + winddelenpermill);
            Homey.log("[" + device_data.name + "] Production today: " + energy);
            Homey.log("[" + device_data.name + "] Energy: " + energy + "KWh");
            Homey.log("[" + device_data.name + "] Year to date: " + yieldYearly + "KWh");
            Homey.log("[" + device_data.name + "] Lifetime: " + yieldLifetime + "MWh");
        } else {
